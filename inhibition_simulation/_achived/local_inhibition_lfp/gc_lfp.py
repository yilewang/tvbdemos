...
raw_data = tvb_lfp_sj3d(args.Gc, file)
np.save(pjoin('/scratch/yilewang/local_inhibition_lfp_gc/',args.Group,args.Caseid+"_"+str(args.Gc)+".npy"), raw_data)
