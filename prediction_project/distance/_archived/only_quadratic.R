...
table <- as.data.frame(read_excel(file_path, sheet = "only_quadratic", skip = 1))
...
# Each block
ignition.table <- table[13:18]
m.color.design[13:18] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))

tvb_para.table <- table[19]
m.color.design[19] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))

MC.table <- table[20:31]
m.color.design[20:31] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))

SimFreq.table <- table[32]
m.color.design[32] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))

sc.table <- table[33:36]
m.color.design[33:36] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))
