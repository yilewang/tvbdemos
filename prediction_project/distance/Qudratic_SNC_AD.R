...
SimFreq.table <- table[15:24]
m.color.design[15:24] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))

wdc.table <- table[25:31]
m.color.design[25:31] <- prettyGraphsColorSelection(starting.color = sample(1:170, 1))
