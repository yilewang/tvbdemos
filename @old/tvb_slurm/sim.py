...
if __name__ == "__main__":
    the_file = '/script/'+netid+'/'+args.grp+'/'+args.caseid+'.zip'
    ...
    save_path='/script/'+netid+'/'+args.grp+'/'+args.caseid+'_'+str(args.gc)+'.csv'
    save_path_pic = '/script/'+netid+'/'+args.grp+'/'+args.caseid+'_'+str(args.gc)+'.png'
    df.to_csv(save_path)
