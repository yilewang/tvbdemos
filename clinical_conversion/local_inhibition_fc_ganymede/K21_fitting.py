...
data_dir = '/home/yxw190015/scratch/workspaces/data4project/'
...
df.to_csv(pjoin('/home/yxw190015/scratch/local_inhibition/',args.Group,args.Caseid+"_"+str(args.K21)+".csv"), index=False)
